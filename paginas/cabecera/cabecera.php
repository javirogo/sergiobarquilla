        ...
        <header>
            ...
            <?php
                if (isset($_SESSION['alias'])){
                    ...
                    echo "<a href='./paginas/cerrarsesion.php'>Cerrar sesión</a>";
                    echo "</div>";
                    echo "</div>";
                } 
            ?>
                    ...
                    <div class="menu_defecto">
                        <nav class=menu id="header">
                            ...
                            <div class="enlaces" id="enlaces">
                                ...
                                <a href="./paginas/quien_es.php" >¿Quién es?</a>
                                <a href="./paginas/espectaculo.php" >Espectáculos</a>
                                <a href="./paginas/galeria/" >Imágenes</a>
                            </div>
                        </nav>
                    </div>
                </div>
